...
| `data/processed/nirf_coverage_gaps.md` | Institutions missing NIRF funding/patents (regenerated by `10_verification_checklist.py`) |
| `data/logs/patent_coverage_gaps.json` | Per-institute patent gap reasons |
| `data/logs/aishe_coverage_summary.json` | Optional AISHE xlsx stats (`validate_aishe.py`) |
...
- **AISHE / geo CSV** — institution locations (AISHE xlsx optional; validated by `validate_aishe.py`)
